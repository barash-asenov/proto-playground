...
/**
 * Generated from protobuf message <code>addressbookv2.PhoneNumber</code>
 */
class PhoneNumber extends \Google\Protobuf\Internal\Message
{
    ...
    protected $number = '';
    /**
     * Generated from protobuf field <code>.addressbookv2.PhoneType type = 2;</code>
     */
    protected $type = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Addressbookv2\PhoneType::class);
        $this->type = $var;
